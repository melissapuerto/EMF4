 ...
 * from:
 *   platform:/resource/org.eclipse.emf.java.test/model/Education.ecore
 * using:
 *   platform:/resource/org.eclipse.emf.java.test/model/Education.genmodel
...
public class EducationTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ CollectionTypeId SEQ_DATAid_EInt = TypeId.SEQUENCE.getSpecializedId(EducationTables.DATAid_EInt, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _Assessment__Assessment = new ExecutorFragment(Types._Assessment, Education.Education.EducationTables.Types._Assessment);
		...
		private static final ExecutorFragment _Course__Course = new ExecutorFragment(Types._Course, Education.Education.EducationTables.Types._Course);
		private static final ExecutorFragment _Course__NamedElement = new ExecutorFragment(Types._Course, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _CourseMaterial__CourseMaterial = new ExecutorFragment(Types._CourseMaterial, Education.Education.EducationTables.Types._CourseMaterial);
		...
		private static final ExecutorFragment _DayOfWeek__DayOfWeek = new ExecutorFragment(Types._DayOfWeek, Education.Education.EducationTables.Types._DayOfWeek);
		...
		private static final ExecutorFragment _Department__Department = new ExecutorFragment(Types._Department, Education.Education.EducationTables.Types._Department);
		private static final ExecutorFragment _Department__NamedElement = new ExecutorFragment(Types._Department, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _EducationMaterial__EducationMaterial = new ExecutorFragment(Types._EducationMaterial, Education.Education.EducationTables.Types._EducationMaterial);
		...
		private static final ExecutorFragment _Enrollment__Enrollment = new ExecutorFragment(Types._Enrollment, Education.Education.EducationTables.Types._Enrollment);
		...
		private static final ExecutorFragment _Grade__Grade = new ExecutorFragment(Types._Grade, Education.Education.EducationTables.Types._Grade);
		...
		private static final ExecutorFragment _HighSchool__HighSchool = new ExecutorFragment(Types._HighSchool, Education.Education.EducationTables.Types._HighSchool);
		private static final ExecutorFragment _HighSchool__NamedElement = new ExecutorFragment(Types._HighSchool, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _MaterialType__MaterialType = new ExecutorFragment(Types._MaterialType, Education.Education.EducationTables.Types._MaterialType);
		...
		private static final ExecutorFragment _NamedElement__NamedElement = new ExecutorFragment(Types._NamedElement, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _Room__NamedElement = new ExecutorFragment(Types._Room, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _Room__Room = new ExecutorFragment(Types._Room, Education.Education.EducationTables.Types._Room);
		...
		private static final ExecutorFragment _Schedule__Schedule = new ExecutorFragment(Types._Schedule, Education.Education.EducationTables.Types._Schedule);
		...
		private static final ExecutorFragment _Score__Score = new ExecutorFragment(Types._Score, Education.Education.EducationTables.Types._Score);
		...
		private static final ExecutorFragment _Semester__Semester = new ExecutorFragment(Types._Semester, Education.Education.EducationTables.Types._Semester);
		...
		private static final ExecutorFragment _SemesterOffered__SemesterOffered = new ExecutorFragment(Types._SemesterOffered, Education.Education.EducationTables.Types._SemesterOffered);
		...
		private static final ExecutorFragment _Status__Status = new ExecutorFragment(Types._Status, Education.Education.EducationTables.Types._Status);

		private static final ExecutorFragment _Student__NamedElement = new ExecutorFragment(Types._Student, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _Student__Student = new ExecutorFragment(Types._Student, Education.Education.EducationTables.Types._Student);
		private static final ExecutorFragment _Student__User = new ExecutorFragment(Types._Student, Education.Education.EducationTables.Types._User);

		private static final ExecutorFragment _Teacher__NamedElement = new ExecutorFragment(Types._Teacher, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _Teacher__Teacher = new ExecutorFragment(Types._Teacher, Education.Education.EducationTables.Types._Teacher);
		private static final ExecutorFragment _Teacher__User = new ExecutorFragment(Types._Teacher, Education.Education.EducationTables.Types._User);
		...
		private static final ExecutorFragment _Type__Type = new ExecutorFragment(Types._Type, Education.Education.EducationTables.Types._Type);

		private static final ExecutorFragment _User__NamedElement = new ExecutorFragment(Types._User, Education.Education.EducationTables.Types._NamedElement);
		...
		private static final ExecutorFragment _User__User = new ExecutorFragment(Types._User, Education.Education.EducationTables.Types._User);
	...
	public static class FragmentOperations {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _Student__Student = {
			Education.Education.EducationTables.Operations._Student__isEligibleForHonors /* isEligibleForHonors() */
		};
		...
		private static final ExecutorOperation /*@NonNull*/ [] _Teacher__Teacher = {
			Education.Education.EducationTables.Operations._Teacher__isExperiencedTeacher /* isExperiencedTeacher() */
		};
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Assessment = {
			Education.Education.EducationTables.Properties._Assessment__Comments,
			Education.Education.EducationTables.Properties._Assessment__DueDate,
			Education.Education.EducationTables.Properties._Assessment__Grades,
			Education.Education.EducationTables.Properties._Assessment__ID,
			Education.Education.EducationTables.Properties._Assessment__Type,
			Education.Education.EducationTables.Properties._Assessment__Weight,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Course = {
			Education.Education.EducationTables.Properties._Course__Assessment,
			Education.Education.EducationTables.Properties._Course__CourseMaterial,
			Education.Education.EducationTables.Properties._Course__Credits,
			Education.Education.EducationTables.Properties._Course__Departments,
			Education.Education.EducationTables.Properties._Course__Description,
			Education.Education.EducationTables.Properties._Course__Enrollment,
			Education.Education.EducationTables.Properties._Course__ID,
			Education.Education.EducationTables.Properties._Course__Lecturer,
			Education.Education.EducationTables.Properties._NamedElement__Name,
			Education.Education.EducationTables.Properties._Course__Room,
			Education.Education.EducationTables.Properties._Course__Semester,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _CourseMaterial = {
			Education.Education.EducationTables.Properties._CourseMaterial__AccessURL,
			Education.Education.EducationTables.Properties._CourseMaterial__FileSize,
			Education.Education.EducationTables.Properties._CourseMaterial__Format,
			Education.Education.EducationTables.Properties._CourseMaterial__LastUpdate,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Department = {
			Education.Education.EducationTables.Properties._Department__Description,
			Education.Education.EducationTables.Properties._Department__FacultyHead,
			Education.Education.EducationTables.Properties._Department__ID,
			Education.Education.EducationTables.Properties._NamedElement__Name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _EducationMaterial = {
			Education.Education.EducationTables.Properties._EducationMaterial__ResourceID,
			Education.Education.EducationTables.Properties._EducationMaterial__Title,
			Education.Education.EducationTables.Properties._EducationMaterial__Type,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Enrollment = {
			Education.Education.EducationTables.Properties._Enrollment__ID,
			Education.Education.EducationTables.Properties._Enrollment__Students,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Grade = {
			Education.Education.EducationTables.Properties._Grade__Assesment,
			Education.Education.EducationTables.Properties._Grade__DateAssigned,
			Education.Education.EducationTables.Properties._Grade__ID,
			Education.Education.EducationTables.Properties._Grade__MaxScore,
			Education.Education.EducationTables.Properties._Grade__Score,
			Education.Education.EducationTables.Properties._Grade__Student,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _HighSchool = {
			Education.Education.EducationTables.Properties._HighSchool__Courses,
			Education.Education.EducationTables.Properties._HighSchool__DepartmentCount,
			Education.Education.EducationTables.Properties._HighSchool__Departments,
			Education.Education.EducationTables.Properties._HighSchool__FoundedYear,
			Education.Education.EducationTables.Properties._HighSchool__ID,
			Education.Education.EducationTables.Properties._NamedElement__Name,
			Education.Education.EducationTables.Properties._HighSchool__Rooms,
			Education.Education.EducationTables.Properties._HighSchool__Teachers,
			Education.Education.EducationTables.Properties._HighSchool__TotalCapacity,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Room = {
			Education.Education.EducationTables.Properties._Room__Capacity,
			Education.Education.EducationTables.Properties._Room__ID,
			Education.Education.EducationTables.Properties._NamedElement__Name,
			Education.Education.EducationTables.Properties._Room__ReservedClassroom,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Schedule = {
			Education.Education.EducationTables.Properties._Schedule__Course,
			Education.Education.EducationTables.Properties._Schedule__DayOfWeek,
			Education.Education.EducationTables.Properties._Schedule__Duration,
			Education.Education.EducationTables.Properties._Schedule__ID,
			Education.Education.EducationTables.Properties._Schedule__StartTime,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Semester = {
			Education.Education.EducationTables.Properties._Semester__ID,
			Education.Education.EducationTables.Properties._Semester__Term,
			Education.Education.EducationTables.Properties._Semester__Year,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Student = {
			Education.Education.EducationTables.Properties._User__Email,
			Education.Education.EducationTables.Properties._Student__GPA,
			Education.Education.EducationTables.Properties._User__ID,
			Education.Education.EducationTables.Properties._NamedElement__Name,
			Education.Education.EducationTables.Properties._Student__Status,
			Education.Education.EducationTables.Properties._Student__YearOfEnrollment,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Teacher = {
			...
			Education.Education.EducationTables.Properties._User__ID,
			Education.Education.EducationTables.Properties._NamedElement__Name,
			Education.Education.EducationTables.Properties._Teacher__Qualification,
			Education.Education.EducationTables.Properties._Teacher__Specialization,
			Education.Education.EducationTables.Properties._Teacher__YearsOfExperience,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
