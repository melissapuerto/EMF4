 ...
 * </p>
 * <ul>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getID <em>ID</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getFoundedYear <em>Founded Year</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getDepartments <em>Departments</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getTeachers <em>Teachers</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getRooms <em>Rooms</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getDepartmentCount <em>Department Count</em>}</li>
 *   <li>{@link Education.Education.impl.HighSchoolImpl#getTotalCapacity <em>Total Capacity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HighSchoolImpl extends NamedElementImpl implements HighSchool {
	...
	public int getDepartmentCount() {
		...
		final /*@NonInvalid*/ List<Education.Education.Department> Departments = this.getDepartments();
	...
	public int getTotalCapacity() {
		/**
		 * self.Rooms->collect(Capacity)->sum()
		 */
		final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
		final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
		final /*@NonInvalid*/ List<Education.Education.Room> Rooms = this.getRooms();
		final /*@NonInvalid*/ OrderedSetValue BOXED_Rooms = idResolver.createOrderedSetOfAll(EducationTables.ORD_CLSSid_Room, Rooms);
		/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(EducationTables.SEQ_DATAid_EInt);
		Iterator<Object> ITERATOR__1 = BOXED_Rooms.iterator();
		...
		while (true) {
			...
			/*@NonInvalid*/ Education.Education.Room _1 = (Education.Education.Room)ITERATOR__1.next();
			/**
			 * Capacity
			 */
			final /*@NonInvalid*/ int Capacity = _1.getCapacity();
			final /*@NonInvalid*/ IntegerValue BOXED_Capacity = ValueUtil.integerValueOf(Capacity);
			//
			accumulator.add(BOXED_Capacity);
		}
		final /*@NonInvalid*/ IntegerValue sum = (IntegerValue)CollectionSumOperation.INSTANCE.evaluate(executor, EducationTables.DATAid_EInt, collect);
	...
	public void setTotalCapacity(int newTotalCapacity) {
		// TODO: implement this method to set the 'Total Capacity' attribute
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case EducationPackage.HIGH_SCHOOL__TOTAL_CAPACITY:
				return getTotalCapacity() != TOTAL_CAPACITY_EDEFAULT;
		}
