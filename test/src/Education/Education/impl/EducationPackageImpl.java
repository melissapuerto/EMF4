...
import Education.Education.Assessment;
import Education.Education.Course;
import Education.Education.CourseMaterial;
import Education.Education.DayOfWeek;
import Education.Education.Department;
import Education.Education.EducationFactory;
import Education.Education.EducationMaterial;
import Education.Education.EducationPackage;
import Education.Education.Enrollment;
import Education.Education.Grade;
import Education.Education.HighSchool;
import Education.Education.MaterialType;
import Education.Education.NamedElement;
import Education.Education.Room;
import Education.Education.Schedule;
import Education.Education.Score;
import Education.Education.Semester;
import Education.Education.SemesterOffered;
import Education.Education.Status;
import Education.Education.Student;
import Education.Education.Teacher;
import Education.Education.Type;
import Education.Education.User;

import Education.Education.util.EducationValidator;
...
public class EducationPackageImpl extends EPackageImpl implements EducationPackage {
	 ...
	 * @see Education.Education.EducationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EducationPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Education.EducationPackage.eNS_URI);
		Education.impl.EducationPackageImpl theEducationPackage_1 = (Education.impl.EducationPackageImpl)(registeredPackage instanceof Education.impl.EducationPackageImpl ? registeredPackage : Education.EducationPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		Education.EducationPackage theEducationPackage_1 = (Education.EducationPackage)EPackage.Registry.INSTANCE.getEPackage(Education.EducationPackage.eNS_URI);
		...
		highSchoolEClass.getESuperTypes().add(theEducationPackage_1.getNamedElement());
		departmentEClass.getESuperTypes().add(theEducationPackage_1.getNamedElement());
		studentEClass.getESuperTypes().add(theEducationPackage_1.getUser());
		courseEClass.getESuperTypes().add(theEducationPackage_1.getNamedElement());
		roomEClass.getESuperTypes().add(theEducationPackage_1.getNamedElement());
		teacherEClass.getESuperTypes().add(theEducationPackage_1.getUser());
		userEClass.getESuperTypes().add(theEducationPackage_1.getNamedElement());
		...
		initEReference(getHighSchool_Departments(), theEducationPackage_1.getDepartment(), null, "Departments", null, 0, -1, HighSchool.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHighSchool_Courses(), theEducationPackage_1.getCourse(), null, "Courses", null, 0, -1, HighSchool.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHighSchool_Teachers(), theEducationPackage_1.getTeacher(), null, "Teachers", null, 0, -1, HighSchool.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHighSchool_Rooms(), theEducationPackage_1.getRoom(), null, "Rooms", null, 0, -1, HighSchool.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStudent_Status(), theEducationPackage_1.getStatus(), "Status", null, 0, 1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAssessment_Type(), theEducationPackage_1.getType(), "Type", null, 0, 1, Assessment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssessment_Grades(), theEducationPackage_1.getGrade(), null, "Grades", null, 0, -1, Assessment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCourse_CourseMaterial(), theEducationPackage_1.getCourseMaterial(), null, "CourseMaterial", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Enrollment(), theEducationPackage_1.getEnrollment(), null, "Enrollment", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Departments(), theEducationPackage_1.getDepartment(), null, "Departments", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Lecturer(), theEducationPackage_1.getTeacher(), null, "Lecturer", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Assessment(), theEducationPackage_1.getAssessment(), null, "Assessment", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Room(), theEducationPackage_1.getRoom(), null, "Room", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Semester(), theEducationPackage_1.getSemester(), null, "Semester", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEducationMaterial_Type(), theEducationPackage_1.getMaterialType(), "Type", null, 0, 1, EducationMaterial.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEnrollment_Students(), theEducationPackage_1.getStudent(), null, "Students", null, 0, -1, Enrollment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGrade_Score(), theEducationPackage_1.getScore(), "Score", null, 0, 1, Grade.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGrade_Student(), theEducationPackage_1.getStudent(), null, "Student", null, 0, 1, Grade.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrade_Assesment(), theEducationPackage_1.getAssessment(), null, "Assesment", null, 0, 1, Grade.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRoom_ReservedClassroom(), theEducationPackage_1.getSchedule(), null, "ReservedClassroom", null, 0, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSchedule_DayOfWeek(), theEducationPackage_1.getDayOfWeek(), "DayOfWeek", null, 0, 1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSchedule_Course(), theEducationPackage_1.getCourse(), null, "Course", null, 0, 1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSemester_Term(), theEducationPackage_1.getSemesterOffered(), "Term", null, 0, 1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
