 ...
 * </p>
 * <ul>
 *   <li>{@link Education.Education.impl.CourseImpl#getID <em>ID</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getCredits <em>Credits</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getCourseMaterial <em>Course Material</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getEnrollment <em>Enrollment</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getDepartments <em>Departments</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getLecturer <em>Lecturer</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getAssessment <em>Assessment</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link Education.Education.impl.CourseImpl#getSemester <em>Semester</em>}</li>
 * </ul>
 *
 * @generated
 */
