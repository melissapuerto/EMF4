 ...
 * <!-- end-user-doc -->
 * @see Education.Education.EducationPackage#getScore()
 * @model
 * @generated
 */
public enum Score implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<Score> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Score</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Score get(String literal) {
	 ...
	 * @generated
	 */
	public static Score getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Score result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Score</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private Score(int value, String name, String literal) {
		this.value = value;
		this.name = name;
