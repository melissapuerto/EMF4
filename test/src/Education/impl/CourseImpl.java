...
public class CourseImpl extends NamedElementImpl implements Course {
	...
	public boolean ValidCredits(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, Education.Education.EducationPackage.Literals.COURSE___VALID_CREDITS__DIAGNOSTICCHAIN_MAP);
