...
public class AssessmentImpl extends MinimalEObjectImpl.Container implements Assessment {
	...
	public boolean ValidWeight(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, Education.Education.EducationPackage.Literals.ASSESSMENT___VALID_WEIGHT__DIAGNOSTICCHAIN_MAP);
