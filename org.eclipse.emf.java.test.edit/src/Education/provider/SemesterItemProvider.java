...
/**
 * This is the item provider adapter for a {@link Education.Semester} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SemesterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Semester_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Semester_ID_feature", "_UI_Semester_type"),
				 EducationPackage.Literals.SEMESTER__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EducationPackage.Literals.SEMESTER__YEAR,
				 true,
				 false,
				 false,
	...
	protected void addTermPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Semester_Term_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Semester_Term_feature", "_UI_Semester_type"),
				 EducationPackage.Literals.SEMESTER__TERM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Semester)object).getID();
